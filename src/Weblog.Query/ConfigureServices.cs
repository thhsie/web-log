...
using Weblog.Query.Data.Context;
using Weblog.Query.Data.Mappings;
using Weblog.Query.Data.Repositories;
using Weblog.Query.Data.Repositories.Abstractions;

namespace Weblog.Query;
...
public static class ConfigureServices
{
    ...
    public static IServiceCollection AddReadOnlyRepositories(this IServiceCollection services) =>
        services.AddScoped<IUserReadOnlyRepository, UserReadOnlyRepository>()
                .AddScoped<IBlogReadOnlyRepository, BlogReadOnlyRepository>();
    ...
    private static void ConfigureMongoDb()
    {
        try
        {
            ...
            new UserMap().Configure(); // Configuration for User class
            new BlogMap().Configure(); // Configuration for Blog class
        }
        catch
        {
            // Ignore
